...
const Student = ({ role } : { role : string }) => {
    const { id } = useParams();
    ...
    const handleSave = async () => {
        ...
        if (
            ...
            if(!id) navigate(`/${role}/students`)
        }
    };

    return (
        <div className="w-full min-h-screen bg-gradient-to-br from-red-50 via-red-100 to-red-200">
                ...
                <div className="max-w-7xl mx-auto px-6 py-4">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold bg-gradient-to-r from-red-900 to-red-600 bg-clip-text text-transparent">
            ...
            <div className="max-w-4xl mx-auto p-6 pt-8">
                <div className="bg-white/70 backdrop-blur-sm rounded-2xl border border-gray-200/50 shadow-xl shadow-gray-500/5 overflow-hidden">
                    ...
                    {/* Form Header */}
                    <div className="bg-gradient-to-r from-red-500/10 via-red-600/10 to-red-700/10 px-8 py-6 border-b border-gray-200/50">
                        <div className="flex items-center gap-3">
                    ...
                    <div className="bg-gray-50/50 px-8 py-6 border-t border-gray-200/50">
                        <div className="flex items-center justify-end gap-4">
                            ...
                            <button
                                onClick={handleSave}
                                className="flex items-center gap-3 px-8 py-3 bg-red-600 text-white rounded-xl hover:bg-red-500 font-medium shadow-lg hover:shadow-xl cursor-pointer"
                            >
                                <Check size={18} />
